...
let Home = {
    ...
    render: async function () {
        let postcards = ''
        for (const meta in PostsMetadata) {
            console.log(`${property}: ${object[property]}`);
        }
        let view =  /*html*/`
            <section class="px-16 h-screen flex items-center justify-center">

            <div class="prose prose-xl text-gray-400 text-center">
                ...
                <p class="">
                    Welcome to this temple to my Ego.
                </p>
                <p>
            ...
            <div class="p-16 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div
                    ...
                    <div>
                        <img class="flex-none h-32 w-32 rounded-xl ring-2 ring-white" src="assets/1.png" alt="">
                    </div>
                    <div>
                        <h1 class="text-xl font-bold text-gray-700 mb-2">Job Security</h1>
                        <p class="text-gray-600 w-80 text-sm">Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                            Dicta cupiditate ut laboriosam!</p>
                    </div>
                </div>
